      ...
      def self.included(base)
        base.decide :impact, :with => :characteristics do
          ...
          committee :carbon do
            ...
            quorum 'from natural gas use, fuel oil use, electricity use, steam use, electricity emission factor, and steam emission factor', :needs => [:natural_gas_use, :fuel_oil_use, :electricity_use, :steam_use, :electricity_emission_factor, :steam_emission_factor],
          ...
          #### Steam emission factor (*kg CO<sub>2</sub> / MJ*)
          # *A greenhouse gas emission factor for steam used by the lodging.*
          committee :steam_emission_factor do
            quorum 'default',
              :complies => [:ghg_protocol_scope_3, :iso, :tcr] do
                ...
                # Assume half of steam is generated by natural gas boilers with 81.7% efficiency, half is generated by fuel oil boilers with 84.6% efficiency, and that transmission losses are 5%, giving *kg CO<sub>2</sub> / MJ*.
          ...
          #### Steam use (*MJ*)
          # The lodging's steam use during `timeframe`.
          committee :steam_use do
            # Multiply `room nights` (*room-nights*) by `steam intensity` (*MJ / room-night*) to give *MJ*.
            quorum 'from fuel intensities and room nights', :needs => [:fuel_intensities, :room_nights],
              :complies => [:ghg_protocol_scope_3, :iso, :tcr] do |characteristics|
